...
By default, bitcoinlimitededitiond will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinlimitededitionTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give bitcoinlimitededitiond a second to reload the mempool
        ...
        self.log.debug("Prevent bitcoinlimitededitiond from writing mempool.dat to disk. Verify that `savemempool` fails")
