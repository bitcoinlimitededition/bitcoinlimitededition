...
# TestP2PConn: A peer we use to send messages to bitcoinlimitededitiond, and store responses.
...
class CompactBlocksTest(BitcoinlimitededitionTestFramework):
    ...
    # This test actually causes bitcoinlimitededitiond to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinlimitededitiond's choice of nonce.
    ...
    # Test that bitcoinlimitededitiond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinlimitededitiond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinlimitededitiond will not send blocktxn responses for blocks whose height is
