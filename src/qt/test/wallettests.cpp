...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitcoinlimitededitionAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bitcoinlimitededition-qt -platform xcb      # Linux
//     src/qt/test/test_bitcoinlimitededition-qt -platform windows  # Windows
//     src/qt/test/test_bitcoinlimitededition-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = BitcoinlimitededitionUnits::formatWithUnit(unit, balance, false, BitcoinlimitededitionUnits::separatorAlways);
    ...
    // Amount input
    BitcoinlimitededitionAmountField* amountInput = receiveCoinsDialog.findChild<BitcoinlimitededitionAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bitcoinlimitededition:")) != -1);
