...
{
    RenameThread("bitcoinlimitededition-http");
...
{
    RenameThread("bitcoinlimitededition-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/bitcoinlimitededition/bitcoinlimitededition/pull/6990)
