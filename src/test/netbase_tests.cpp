...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinlimitededition.org", "www.bitcoinlimitededition.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinlimitededition.org]", "www.bitcoinlimitededition.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinlimitededition.org:80", "www.bitcoinlimitededition.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinlimitededition.org]:80", "www.bitcoinlimitededition.org", 80));
