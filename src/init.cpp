 ...
 * between bitcoinlimitededitiond, and bitcoinlimitededition-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("bitcoinlimitededition-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinlimitededition/bitcoinlimitededition>";
    const std::string URL_WEBSITE = "<https://bitcoinlimitededitioncore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitcoinlimitededition-loadblk");
...
/** Sanity checks
 *  Ensure that Bitcoinlimitededition is running in a usable environment with all
...
{
    // Make sure only a single Bitcoinlimitededition process is using the data directory.
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if bitcoinlimitededition is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if bitcoinlimitededition is started while in a temporary directory.\n",
