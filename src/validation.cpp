...
#if defined(NDEBUG)
# error "Bitcoinlimitededition cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bitcoinlimitededition Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BLE additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("bitcoinlimitededition-scriptch");
