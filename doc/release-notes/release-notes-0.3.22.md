Download URL: https://sourceforge.net/projects/bitcoinlimitededition/files/Bitcoinlimitededition/bitcoinlimitededition-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BLE fee schedule (users still pay 0.01 BLE per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinlimitededition00 - #bitcoinlimitededition99
