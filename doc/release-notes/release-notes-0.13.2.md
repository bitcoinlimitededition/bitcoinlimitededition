Bitcoinlimitededition Core version 0.13.2 is now available from:

  <https://bitcoinlimitededition.org/bin/bitcoinlimitededition-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinlimitededition-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinlimitededition-tx to create v2 transactions (btcdrak)
