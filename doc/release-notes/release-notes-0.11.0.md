Bitcoinlimitededition Core version 0.11.0 is now available from:

  <https://bitcoinlimitededition.org/bin/bitcoinlimitededition-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer BLE/kB fee to be
...
For example, add the following to `bitcoinlimitededition.conf`:
...
related to the blockchain in the bitcoinlimitededition system: the raw blocks as received over 
the network (blk???.dat), the undo data (rev???.dat), the block index and the 
UTXO set (both LevelDB databases). The databases are built from the raw data.

Block pruning allows Bitcoinlimitededition Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Bitcoinlimitededition Core will 
...
For an example script see [bitcoinlimitededition-submittx](https://github.com/laanwj/bitcoinlimitededition-submittx).
...
- #5334 `cf87536` libbitcoinlimitededitionconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new bitcoinlimitededition-detached-sigs git repo for OSX signatures
...
- #5729 `9c4a5a5` Allow unit changes for read-only BitcoinlimitededitionAmountField
- #5753 `0f44672` Add bitcoinlimitededition logo to about screen
...
- #5809 `46bfbe7` Add bitcoinlimitededition-cli man page
...
- #5849 `41259ca` contrib/init/bitcoinlimitededitiond.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Bitcoinlimitededition-Qt.app to Bitcoinlimitededition-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for bitcoinlimitededition-tx)
...
- Ben Holden-Crowther
- bikinibabe
- BitcoinlimitededitionPRReadingGroup
- Blake Jakopovic
- BtcDrak
- charlescharles
- Chris Arnesen
