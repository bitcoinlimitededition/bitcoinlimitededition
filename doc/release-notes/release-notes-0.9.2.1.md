Bitcoinlimitededition Core version 0.9.2.1 is now available from:

  https://bitcoinlimitededition.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BLE to 0.01 BLE
...
- Fix "Start bitcoinlimitededition on system login"
