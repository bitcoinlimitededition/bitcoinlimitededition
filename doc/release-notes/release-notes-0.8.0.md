Bitcoinlimitededition-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinlimitededition/files/Bitcoinlimitededition/bitcoinlimitededition-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoinlimitededition
...
New/changed settings (command-line or bitcoinlimitededition.conf file)
--------------------------------------------------------
