Bitcoinlimitededition Core version 0.9.4 is now available from:

  https://bitcoinlimitededition.org/bin/0.9.4/
...
this update is incompatible with the Bitcoinlimitededition system and could lead to consensus
forks.

Bitcoinlimitededition Core released binaries from https://bitcoinlimitededition.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinlimitededition/+archive/ubuntu/bitcoinlimitededition
- A third-party or self-compiled Bitcoinlimitededition Core

upgrade to Bitcoinlimitededition Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
