Bitcoinlimitededition Core version 0.10.4 is now available from:

  <https://bitcoinlimitededition.org/bin/bitcoinlimitededition-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinlimitededition-tx into its own package
- #6953 `dfe0d4d` Include bitcoinlimitededition-tx binary on Debian/Ubuntu
