...
This document provides guidelines for internationalization of the Bitcoinlimitededition Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinlimitededition_en.ts` remains unchanged.
